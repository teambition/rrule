...
RRule.prototype = {
     ...
     * @return Date or null
     */
    before: function(dt, inc, forceToReturnArray) {
        var args = {
                dt: dt,
                inc: inc,
                forceToReturnArray: forceToReturnArray
            },
     ...
     * @return Date or null
     */
    after: function(dt, inc, forceToReturnArray) {
        var args = {
                dt: dt,
                inc: inc,
                forceToReturnArray: forceToReturnArray
    ...
    accept: function(date) {
        ...
        if (this.method == 'between') {
            ...
            if (tooEarly)
                return true;
            this.add(date);
            if (!this.args.forceToReturnArray) {
                return false
            } else {
              return true
            }
...
var GenItem = function (genlist, gen, method, args) {
    if (gen instanceof RRule) {
        if (method == 'before' || method == 'after') {
            args.push(true) // forceToReturnArray
        }
